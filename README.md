...
- Here, the template has been modified by [Hanif Rahmat](https://github.com/hanifrahmath/template_disertasi_ilkom_dike_ugm) for a doctoral dissertation at Doctoral Program in Computer Science, DIKE FMIPA UGM.
...
### Main files
```
|-- disertasidikeugm.cls (Class file)
...
|-- packages/myapacite.bst (A custom bibliography style)
